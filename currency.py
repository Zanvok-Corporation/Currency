...
API_KEY = '0c60fe3020d7dfd85070638f'

# the Standard request url
url = f'https://v6.exchangerate-api.com/v6/0c60fe3020d7dfd85070638f/latest/USD'
...
name_label = Label(top_frame, text='Zanvok Currency', bg=primary, fg=white, pady=30, padx=24, justify=CENTER, font=('Poppins 20 bold'))
